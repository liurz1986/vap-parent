 ...
 * 基于BC库的ECC算法的工具类
 * @author King
 * @since 2019/08/06 20:24
 */
public class BcEccUtils {
	...
	public static BCECPublicKey createPublicKeyFromSubjectPublicKeyInfo(SubjectPublicKeyInfo subPubInfo) throws NoSuchProviderException,
		...
		return BcEccUtils.convertX509ToECPublicKey(subPubInfo.toASN1Primitive().getEncoded(ASN1Encoding.DER));
	}
	...
	public static String convertECPrivateKeyPKCS8ToPEM(byte[] encodedKey) throws IOException {
		return convertEncodedDataToPEM(PEM_STRING_EC_PRIVATE_KEY, encodedKey);
	}
