...
public class Sm2Utils {
	...
	public static final ECDomainParameters DOMAIN_PARAMS = new ECDomainParameters(CURVE, G_POINT,
			SM2_ECC_N, SM2_ECC_H);
	public static final int CURVE_LEN = BcEccUtils.getCurveLength(DOMAIN_PARAMS);
	...
	public static ECPrivateKeyParameters priKey;

	public static ECPublicKeyParameters pubKey;

	static {
		AsymmetricCipherKeyPair keyPair = generateKeyPairParameter();
		priKey = (ECPrivateKeyParameters) keyPair.getPrivate();
	...
	public static AsymmetricCipherKeyPair generateKeyPairParameter() {
		...
		return BcEccUtils.generateKeyPairParameter(DOMAIN_PARAMS, random);
	}

	public static KeyPair generateKeyPair() throws NoSuchProviderException, NoSuchAlgorithmException,
			InvalidAlgorithmParameterException {
		SecureRandom random = new SecureRandom();
		return BcEccUtils.generateKeyPair(DOMAIN_PARAMS, random);
	}
	...
	public static byte[] encrypt(BCECPublicKey pubKey, byte[] srcData) throws InvalidCipherTextException {
		ECPublicKeyParameters pubKeyParameters = BcEccUtils.convertPublicKeyToParameters(pubKey);
	...
	public static byte[] decrypt(BCECPrivateKey priKey, byte[] sm2Cipher) throws InvalidCipherTextException {
		ECPrivateKeyParameters priKeyParameters = BcEccUtils.convertPrivateKeyToParameters(priKey);
...
//		int curveLength = BcEccUtils.getCurveLength(DOMAIN_PARAMS);
