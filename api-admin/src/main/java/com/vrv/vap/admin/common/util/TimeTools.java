...
//	private static Date STARTTIME = null;
	...
	public void init(){
		timeTools = this;
		timeTools.FORMAT = FORMAT;
		timeTools.FORMAT_MONTH = FORMAT_MONTH;
...
//		YEAR_DAY_ALL = getDays(timeTools.STARTTIME, TimeTools.getNow());
	 ...
	 * @return
	 */
	public static String gtmToUtcTimeString(String gtm, String fmt) {
		return format2(utcTime(toDate(gtm, fmt)));
	}
	 ...
	 * @return
	 */
	public static String formatIndex(Date date) {
		if (null == date) {
			return null;
		}
		return new SimpleDateFormat(timeTools.FORMAT).format(date);
	}
	 ...
	 * @return
	 */
	public static String formatIndexByMonth(Date date) {
		if (null == date) {
			return null;
		}
		return new SimpleDateFormat(timeTools.FORMAT_MONTH).format(date);
	}
	 ...
	 * @return
	 */
	public static int getYEAR_DAY_ALL() {
		int YEAR_DAY_ALL = getDays(timeTools.STARTTIME, TimeTools.getNow());
		return YEAR_DAY_ALL;
	}
	...
	public static Date toDate(String time) {
		return TimeTools.toDate(time, TIMESTAMP);
	}
	...
	/**
	 * 字符串转时间类型 - TimeDate 转换如下格式： 2016-02-15T03:35:00.965Z
	 * 
	 * @param timeStr
	 */
	public static Date parseDate(String timeStr) {
		try {
			return DateTime.parse(timeStr).toDate();
		} catch (Exception e2) {
			log.error("", e2);
		}
		return null;
