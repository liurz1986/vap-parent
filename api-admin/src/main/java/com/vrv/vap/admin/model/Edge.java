...
public class Edge {
     ...
     * 内置条件
     */
    @Column(name = "built_in_condition")
    @ApiModelProperty("内置条件")
    private String builtInCondition;

    /**
     * 目标字段聚合
     */
    @Column(name = "goal_field_aggr")
    @ApiModelProperty("目标字段聚合")
    private Integer goalFieldAggr;
    ...
    public String getBuiltInCondition() {
        return builtInCondition;
    }

    public void setBuiltInCondition(String builtInCondition) {
        this.builtInCondition = builtInCondition;
    }

    public Integer getGoalFieldAggr() {
        return goalFieldAggr;
    }

    public void setGoalFieldAggr(Integer goalFieldAggr) {
        this.goalFieldAggr = goalFieldAggr;
    }
}