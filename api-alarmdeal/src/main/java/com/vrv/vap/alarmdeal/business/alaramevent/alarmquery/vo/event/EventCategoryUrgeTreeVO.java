...
import lombok.Data;
@Data
public class EventCategoryUrgeTreeVO implements ITreeNode<EventCategoryUrgeTreeVO, String> {
	...
	private  List<EventCategoryUrgeTreeVO> children;  
	private EventAlarmSetting urgeInfo;
	private  String nodeType;  //定义类型
