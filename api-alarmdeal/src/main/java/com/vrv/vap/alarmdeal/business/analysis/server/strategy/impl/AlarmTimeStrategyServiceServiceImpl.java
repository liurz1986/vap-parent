...
@Service
public class AlarmTimeStrategyServiceServiceImpl extends BaseStrategyServcie implements ResponseStrategyService {



    @Override
    public int getIndex(){
        return StrategyEnum.TIMESTRATEGY.getIndex();
    }
