...
public class ExportExcelUtils {
	...
	public static void main(String[] args) throws FileNotFoundException, NoSuchFieldException, IllegalAccessException {
		AssetVerifyExportVO vo = new AssetVerifyExportVO();
		vo.setIp("192.168.120.11");
		vo.setName("测试导出aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		vo.setOrgName("北信源11");
		List<AssetVerifyExportVO> lists = new ArrayList<>();
		lists.add(vo);
		ExportExcelUtils.getInstance().createExcel(lists, AssetVerifyExportVO.class,"F:\\user\\test");
