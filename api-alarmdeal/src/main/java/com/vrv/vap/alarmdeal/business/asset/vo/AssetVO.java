...
public class AssetVO {
	...
	public class Info{
		...
		public String getCoreFormat()
		{
			if(Boolean.TRUE.equals(this.core))
			{
				return "是";
			}else
			{
...
*/	    
	...
	private String employeeGuid;
		...
		List<LabelStatusVO> assetLabelStatus;
	    ...
	    private Integer eventNumber; //  2023-07-12 对应事件数量
	    ...
	    private Boolean isJustAssetOfConcern=false; //是否为关注资产
