package com.vrv.vap.alarmdeal.business.flow.define.util;
...
public class ToWeb {
    ...
    public ToWeb setRows(Rows<T> rows) {
        data.put("rows", rows);
        return this;
    }
    public static class Rows<T>{
        ...
        public Rows(long totalRows, int current, int rowSize, int totalPages, List<T> list) {
        ...
        public Rows setList(List<T> list) {
            this.list = list;
            return this;
        }
