...
public class FrequentOrgAll {
    ...
    String sql = "SELECT org,sys_id,GROUP_CONCAT(frequents separator '#') AS frequents FROM base_line_frequent WHERE `org` <> '' GROUP BY org,sys_id";
    public FrequentOrgAll() {
    }
    ...
    public void open(){
        try{
            ...
            replaceInsert = conn.prepareStatement("REPLACE INTO base_line_frequent_org (`org`,sys_id, frequents, update_time) VALUES (?, ?, ?,?)");
