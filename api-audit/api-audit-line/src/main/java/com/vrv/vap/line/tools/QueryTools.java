...
import com.vrv.vap.line.config.MultiClusterConfig;
import com.vrv.vap.line.config.PermissionMappingConfig;
import com.vrv.vap.line.model.EsQueryModel;
import com.vrv.vap.line.model.PageModel;
...
public final class QueryTools {
    ...
    private static PermissionMappingConfig permissionMappingConfig = VapLineApplication.getApplicationContext().getBean(PermissionMappingConfig.class);

    private static MultiClusterConfig multiClusterConfig = VapLineApplication.getApplicationContext().getBean(MultiClusterConfig.class);
    ...
    public static QueryWrapper build(ElasticSearchManager client) {
        return build(client, VapLineApplication.getApplicationContext().getBean(IndexConfig.class));
    }

    public static QueryWrapper build(IndexConfig indexConfig) {
        return build(VapLineApplication.getApplicationContext().getBean(ElasticSearchManager.class), indexConfig);
    }

    public static QueryWrapper build() {
        return build(VapLineApplication.getApplicationContext().getBean(ElasticSearchManager.class),
                VapLineApplication.getApplicationContext().getBean(IndexConfig.class));
    }
    ...
    public static class QueryWrapper {
        ...
        public BulkByScrollResponse deleteByQuery(EsQueryModel queryModel) {
            if (StringUtils.isEmpty(queryModel.getIndexName())) {
                if (log.isDebugEnabled()) {
                    log.debug("indexNames and indexName is null or 0");
                }
            ...
            DeleteByQueryRequest request = new DeleteByQueryRequest(queryModel.getIndexName());
            request.setQuery(queryModel.getQueryBuilder());
            if (log.isDebugEnabled()) {
                log.debug("***********\n" + request + "***********\n");
            }
            log.info("***** request ******\n" + request + "***********\n");
...
//            boolean isAfter = TimeTools.parseDate(time, indexConfig.getTimeForamt()).after(TimeTools.getNowBeforeByDay(2));
     ...
     * @return
     */
    public static EsQueryModel buildQueryModel(QueryWrapper wrapper, PageModel model, String indexName, String[] indexNames, String typeName, String timeField, boolean needTimeFormat, String timeFormat) {
        EsQueryModel queryModel = new EsQueryModel();
     ...
     * @return
     */
    public static EsQueryModel buildQueryModel(QueryWrapper wrapper, PageModel model, String index, String time) {
        EsQueryModel queryModel = new EsQueryModel();
        queryModel.setStart(model.getMyStart());
        queryModel.setCount(model.getMyCount());
...
//        wrapper.setTimeRangeFilter(queryModel);
     ...
     * @return
     */
    public static EsQueryModel buildQueryModelByMonth(QueryWrapper wrapper, PageModel model, String index, String time) {
        EsQueryModel queryModel = new EsQueryModel();
        queryModel.setStart(model.getMyStart());
        queryModel.setCount(model.getMyCount());
        if (model.getMyStartTime() != null && model.getMyEndTime() != null) {
...
//        wrapper.setTimeRangeFilter(queryModel);
     ...
     * @return
     */
    public static EsQueryModel buildQueryModel(QueryWrapper wrapper, PageModel model, String[] indexs, String time) {
        EsQueryModel queryModel = new EsQueryModel();
        queryModel.setStart(model.getMyStart());
        queryModel.setCount(model.getMyCount());
        if (model.getMyStartTime() != null && model.getMyEndTime() != null) {
...
//        wrapper.setTimeRangeFilter(queryModel);
     ...
     * @return
     */
    public static EsQueryModel buildQueryModel(QueryWrapper wrapper, PageModel model, String index) {
        EsQueryModel queryModel = new EsQueryModel();
        queryModel.setStart(model.getMyStart());
        queryModel.setCount(model.getMyCount());
     ...
     * @return
     */
    public static EsQueryModel buildQueryModel(QueryWrapper wrapper, PageModel model, String index, String time, String timeFormat, boolean isMonthIndex) {
        EsQueryModel queryModel = new EsQueryModel();
        queryModel.setStart(model.getMyStart());
        queryModel.setCount(model.getMyCount());
        if (model.getMyStartTime() != null && model.getMyEndTime() != null) {
...
//        wrapper.setTimeRangeFilter(queryModel, timeFormat);
     ...
     * 取总数
     */
    public static int getHits(EsQueryModel queryModel, QueryWrapper wrapper) {
        int result = 0;
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String keyFieldRe, String valueFieldRe) {
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, int minDocSize, String keyFieldRe, String valueFieldRe) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleAggAndTopHit(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String keyField, String valueField, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleTermAndSumAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String sumAggField, String keyFieldRe, String sumFieldRe, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     * @return
     */
    public static Map<String, Object> simpleSumAgg(EsQueryModel queryModel, QueryWrapper wrapper, String[] sumAggFields, String[] sumFieldsRe) {
     ...
     * @return
     */
    public static Map<String, Object> simpleAvgAgg(EsQueryModel queryModel, QueryWrapper wrapper, String[] avgFields, String[] avgFieldsRe) {
        Map<String, Object> result = new HashMap<>();
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleTermAndSumAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String[] sumAggFields, String[] sumFieldsRe, String keyFieldRe, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleTermAndSumAgg2(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size,  String cardField,String[] sumAggFields, String[] sumFieldsRe, String keyFieldRe, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleTermAndStatsAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String sumAggField, String keyFieldRe, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     * }
     */
    public static List<Map<String, Object>> simpleTermAndExtendStatsAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String statsAggField, String keyFieldRe, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     * }
     */
    public static List<Map<String, Object>> twoLevelTermAndExtendStatsAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size,
    ...
    public static List<Map<String, Object>> simpleTermAndSubSumAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String subAggField, String[] sumAggFields, String[] sumFieldsRe, String keyFieldRe, String... topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
    ...
    public static List<Map<String, Object>> simpleTermAndSub2SumAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String subAggField, String subSubAggField,
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleTermAndSumCarAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String cardinalityAggField, String[] sumAggFields, String[] sumFieldsRe, String keyFieldRe, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleCardinalityAgg2(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String cardinalityAggField1, String cardinalityAggField2, String keyField, String cardinalityField1, String cardinalityField2, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleCardinalityAgg(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String cardinalityAggField, String keyField, String cardinalityField, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        if (topHitFields != null) {
     ...
     */
    public static List<Map<String, Object>> simpleAggWithTopHit(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String keyField, String valueField) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        agg.subAggregation(AggregationBuilders.topHits("data").size(1));
     ...
     * @return Map(keyField - > keyName, valueField - > count, " row " - > Map)
     */
    public static List<Map<String, Object>> simpleAggWithTopHit(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String keyField, String valueField, String[] rowFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
        agg.subAggregation(AggregationBuilders.topHits("data").size(1));
     ...
     * @return
     */
    public static List<Map<String, Object>> twoLevelAgg(EsQueryModel queryModel, QueryWrapper wrapper, String oneAggField, String twoAggField, int oneAggSize, int secondAggSize, String valueField) {
        List<Map<String, Object>> result = new ArrayList<>();
     ...
     * @return
     */
    public static List<Map<String, Object>> twoLevelAgg(EsQueryModel queryModel, QueryWrapper wrapper, String oneAggField, String twoAggField, int oneAggSize, int secondAggSize, String valueField, boolean transform) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder oneAgg = new TermsAggregationBuilder("oneAgg");
        oneAgg.field(oneAggField).size(oneAggSize);
        TermsAggregationBuilder secondAgg = new TermsAggregationBuilder("secondAgg");
     ...
     * @return
     */
    public static List<Map<String, Object>> twoLevelAggAndDateAgg(EsQueryModel queryModel, QueryWrapper wrapper, String oneAggField, String twoAggField, int oneAggSize, int secondAggSize, String valueField, String dateAggField, String dateFormat, DateHistogramInterval interval, int offset,  boolean transform) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder oneAgg = new TermsAggregationBuilder("oneAgg");
        oneAgg.field(oneAggField).size(oneAggSize);
        TermsAggregationBuilder secondAgg = new TermsAggregationBuilder("secondAgg");
...
//        dateAgg.dateHistogramInterval(interval);
     ...
     * @return
     */
    public static List<Map<String, Object>> twoLevelAggToHits(EsQueryModel queryModel, QueryWrapper wrapper, String oneAggField, String twoAggField, int oneAggSize, int secondAggSize, String valueField, String[] rowFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder oneAgg = new TermsAggregationBuilder("oneAgg");
        oneAgg.field(oneAggField).size(oneAggSize);
        TermsAggregationBuilder secondAgg = new TermsAggregationBuilder("secondAgg");
     ...
     * @return
     */
    public static List<Map<String, Object>> twoLevelAgg(EsQueryModel queryModel, QueryWrapper wrapper, String oneAggField, String twoAggField, int oneAggSize, int secondAggSize,
     ...
     * @return
     */
    public static List<Map<String, Object>> threeLevelAgg(EsQueryModel queryModel, QueryWrapper wrapper, String oneAggField, String twoAggField, String threeAggField,
    ...
    public static List<Map<String, Object>> cardinalityAndDateAgg(EsQueryModel queryModel, QueryWrapper wrapper, String dateAggField, DateHistogramInterval interval, String dateFormat, int offset, String cardinalityAggField, String keyField, String valueField) {
        List<Map<String, Object>> result = new ArrayList<>();
        DateHistogramAggregationBuilder dateAgg = AggregationBuilders.dateHistogram("dateAgg");
        dateAgg.field(dateAggField);
        dateAgg.dateHistogramInterval(interval);
...
//        dateAgg.timeZone(ZoneId.of("CTT"));
     ...
     * @return
     */
    public static List<Map<String, Object>> dateAgg(EsQueryModel queryModel, QueryWrapper wrapper, String dateAggField, DateHistogramInterval interval, String dateFormat, int offset, String keyField, String valueField) {
        List<Map<String, Object>> result = new ArrayList<>();
        DateHistogramAggregationBuilder dateAgg = AggregationBuilders.dateHistogram("dateAgg");
        dateAgg.field(dateAggField);
        dateAgg.dateHistogramInterval(interval);
     ...
     * @return
     */
    public static List<Map<String, Object>> dateAndSumAgg(EsQueryModel queryModel, QueryWrapper wrapper, String dateAggField, String sumAggField, DateHistogramInterval interval, String dateFormat, int offset, String keyField, String valueField) {
        List<Map<String, Object>> result = new ArrayList<>();
        DateHistogramAggregationBuilder dateAgg = AggregationBuilders.dateHistogram("dateAgg");
        dateAgg.field(dateAggField);
        dateAgg.dateHistogramInterval(interval);
     ...
     * @return
     */
    public static Map<String, Object> simpleCardinalityAgg(EsQueryModel queryModel, QueryWrapper wrapper, String cardinalityAggField, int threshold, String valueField) {
        Map<String, Object> result = new HashMap<>();
     ...
     * @return
     */
    public static int simpleCardinalityAggAndReturnLong(EsQueryModel queryModel, QueryWrapper wrapper, String cardinalityAggField, int threshold) {
        int result = 0;
        CardinalityAggregationBuilder cardinalityAgg = AggregationBuilders.cardinality("cardinalityAgg").field(cardinalityAggField).precisionThreshold(threshold);
        queryModel.setAggregationBuilder(cardinalityAgg);
        queryModel.setUseAggre(true);
     ...
     * @return
     */
    public static List<Map<String, Object>> simpleAggWithCardinality(EsQueryModel queryModel, QueryWrapper wrapper, String aggField, int size, String countField, String keyField, String valueField, String[] topHitFields) {
        List<Map<String, Object>> result = new ArrayList<>();
        TermsAggregationBuilder agg = new TermsAggregationBuilder("agg");
        agg.field(aggField).size(size);
     ...
     * @return
     */
    public static EsQueryModel buildQueryModelByDay(QueryWrapper wrapper, PageModel model, String index, String time) {
        EsQueryModel queryModel = new EsQueryModel();
        queryModel.setStart(model.getMyStart());
        queryModel.setCount(model.getMyCount());
        if (model.getMyStartTime() != null && model.getMyEndTime() != null) {
...
//        wrapper.setTimeRangeFilter(queryModel);
     ...
     * @param wrapper
     */
    public static long getCount(EsQueryModel model, QueryWrapper wrapper) {
        long result = 0;
     ...
     * 写入数据
     */
    public static long writeData(List<?> data, String index, QueryWrapper wrapper) throws Exception {
