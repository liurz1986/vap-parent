...
package com.vrv.vap.es.common.client;
...
public final class Request5 {
    ...
    public Request5(String method, String endpoint, Map<String, String> parameters, HttpEntity entity) {
    ...
    static Request5 delete(DeleteRequest deleteRequest) {
        ...
        return new Request5(HttpDelete.METHOD_NAME, endpoint, parameters.getParams(), null);
    }

    static Request5 deleteIndex(DeleteIndexRequest deleteIndexRequest) {
    ...
    static Request5 info() {
        return new Request5(HttpGet.METHOD_NAME, "/", Collections.emptyMap(), null);
    }

    static Request5 bulk(BulkRequest bulkRequest) throws IOException {
        Params parameters = Params.builder();
        ...
        return new Request5(HttpPost.METHOD_NAME, "/_bulk", parameters.getParams(), entity);
    }

    static Request5 exists(GetRequest getRequest) {
        Request5 request = get(getRequest);
        return new Request5(HttpHead.METHOD_NAME, request.endpoint, request.parameters, null);
    }

    static Request5 get(GetRequest getRequest) {
        ...
        return new Request5(HttpGet.METHOD_NAME, endpoint, parameters.getParams(), null);
    }

    static Request5 index(IndexRequest indexRequest) {
        ...
        return new Request5(method, endpoint, parameters.getParams(), entity);
    }

    static Request5 ping() {
        return new Request5(HttpHead.METHOD_NAME, "/", Collections.emptyMap(), null);
    }

    static Request5 update(UpdateRequest updateRequest) throws IOException {
        ...
        return new Request5(HttpPost.METHOD_NAME, endpoint, parameters.getParams(), entity);
    }

    static Request5 search(SearchRequest searchRequest) throws IOException {
        ...
        return new Request5(HttpGet.METHOD_NAME, endpoint, params.getParams(), entity);
    }

    static Request5 searchScroll(SearchScrollRequest searchScrollRequest) throws IOException {
        HttpEntity entity = createEntity(searchScrollRequest, REQUEST_BODY_CONTENT_TYPE);
        return new Request5("GET", "/_search/scroll", Collections.emptyMap(), entity);
    }

    static Request5 clearScroll(ClearScrollRequest clearScrollRequest) throws IOException {
        HttpEntity entity = createEntity(clearScrollRequest, REQUEST_BODY_CONTENT_TYPE);
        return new Request5("DELETE", "/_search/scroll", Collections.emptyMap(), entity);
    }
