 ...
 * construction using
 * {@link SearchSourceBuilder5#searchSource()}.
 *
 * @see org.elasticsearch.action.search.SearchRequest#source(SearchSourceBuilder5)
 */
public final class SearchSourceBuilder5 implements Writeable, ToXContentObject, Rewriteable<SearchSourceBuilder5> {
    private static final DeprecationLogger DEPRECATION_LOGGER =
        new DeprecationLogger(LogManager.getLogger(SearchSourceBuilder5.class));
    ...
    public static SearchSourceBuilder5 fromXContent(XContentParser parser) throws IOException {
        return fromXContent(parser, true);
    }

    public static SearchSourceBuilder5 fromXContent(XContentParser parser, boolean checkTrailingTokens) throws IOException {
        SearchSourceBuilder5 builder = new SearchSourceBuilder5();
     ...
     */
    public static SearchSourceBuilder5 searchSource() {
        return new SearchSourceBuilder5();
    }
     ...
     */
    public SearchSourceBuilder5() {
        if (Version.CURRENT.onOrAfter(Version.V_6_7_1)) {
            trackTotalHits = true;
        } else {
     ...
     * Read from a stream.
     */
    public SearchSourceBuilder5(StreamInput in) throws IOException {
     ...
     */
    public SearchSourceBuilder5 query(QueryBuilder query) {
     ...
     */
    public SearchSourceBuilder5 postFilter(QueryBuilder postFilter) {
     ...
     */
    public SearchSourceBuilder5 from(int from) {
        if (from < 0) {
     ...
     */
    public SearchSourceBuilder5 size(int size) {
        if (size < 0) {
     ...
     */
    public SearchSourceBuilder5 minScore(float minScore) {
     ...
     */
    public SearchSourceBuilder5 explain(Boolean explain) {
     ...
     */
    public SearchSourceBuilder5 version(Boolean version) {
     ...
     */
    public SearchSourceBuilder5 seqNoAndPrimaryTerm(Boolean seqNoAndPrimaryTerm) {
     ...
     */
    public SearchSourceBuilder5 timeout(TimeValue timeout) {
     ...
     */
    public SearchSourceBuilder5 terminateAfter(int terminateAfter) {
        if (terminateAfter < 0) {
     ...
     *            The sort ordering
     */
    public SearchSourceBuilder5 sort(String name, SortOrder order) {
     ...
     */
    public SearchSourceBuilder5 sort(String name) {
        if (name.equals(ScoreSortBuilder.NAME)) {
     ...
     * Adds a sort builder.
     */
    public SearchSourceBuilder5 sort(SortBuilder<?> sort) {
            if (sorts == null) {
                sorts = new ArrayList<>();
            }
            sorts.add(sort);
     ...
     */
    public SearchSourceBuilder5 trackScores(boolean trackScores) {
    ...
    public SearchSourceBuilder5 trackTotalHits(boolean trackTotalHits) {
     ...
     */
    public SearchSourceBuilder5 searchAfter(Object[] values) {
     ...
     * of the main query.
     */
    public SearchSourceBuilder5 slice(SliceBuilder builder) {
    ...
    public SearchSourceBuilder5 collapse(CollapseBuilder collapse) {
     ...
     */
    public SearchSourceBuilder5 aggregation(AggregationBuilder aggregation) {
     ...
     * Add an aggregation to perform as part of the search.
     */
    public SearchSourceBuilder5 aggregation(PipelineAggregationBuilder aggregation) {
            if (aggregations == null) {
            aggregations = AggregatorFactories.builder();
            }
     ...
     */
    public SearchSourceBuilder5 highlighter(HighlightBuilder highlightBuilder) {
    ...
    public SearchSourceBuilder5 suggest(SuggestBuilder suggestBuilder) {
    ...
    public SearchSourceBuilder5 addRescorer(RescorerBuilder<?> rescoreBuilder) {
    ...
    public SearchSourceBuilder5 clearRescorers() {
     ...
     */
    public SearchSourceBuilder5 profile(boolean profile) {
     ...
     * every hit
     */
    public SearchSourceBuilder5 fetchSource(boolean fetch) {
     ...
     *            the returned _source
     */
    public SearchSourceBuilder5 fetchSource(@Nullable String include, @Nullable String exclude) {
     ...
     *            filter the returned _source
     */
    public SearchSourceBuilder5 fetchSource(@Nullable String[] includes, @Nullable String[] excludes) {
        FetchSourceContext fetchSourceContext = this.fetchSourceContext != null ? this.fetchSourceContext
            : FetchSourceContext.FETCH_SOURCE;
     ...
     */
    public SearchSourceBuilder5 fetchSource(@Nullable FetchSourceContext fetchSourceContext) {
     ...
     * return.
     */
    public SearchSourceBuilder5 storedField(String name) {
     ...
     */
    public SearchSourceBuilder5 storedFields(List<String> fields) {
     ...
     */
    public SearchSourceBuilder5 storedFields(StoredFieldsContext context) {
     ...
     * search request.
     */
    public SearchSourceBuilder5 docValueField(String name, @Nullable String format) {
        if (docValueFields == null) {
     ...
     * search request.
     */
    public SearchSourceBuilder5 docValueField(String name) {
     ...
     *            The script
     */
    public SearchSourceBuilder5 scriptField(String name, Script script) {
     ...
     *            The script
     */
    public SearchSourceBuilder5 scriptField(String name, Script script, boolean ignoreFailure) {
     ...
     */
    public SearchSourceBuilder5 indexBoost(String index, float indexBoost) {
     ...
     */
    public SearchSourceBuilder5 stats(List<String> statsGroups) {
    ...
    public SearchSourceBuilder5 ext(List<SearchExtBuilder> searchExtBuilders) {
     ...
     */
    @Override
    public SearchSourceBuilder5 rewrite(QueryRewriteContext context) throws IOException {
     ...
     */
    public SearchSourceBuilder5 copyWithNewSlice(SliceBuilder slice) {
     ...
     */
    private SearchSourceBuilder5 shallowCopy(QueryBuilder queryBuilder, QueryBuilder postQueryBuilder,
        ...
        SearchSourceBuilder5 rewrittenBuilder = new SearchSourceBuilder5();
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            if (token == XContentParser.Token.FIELD_NAME) {
                ...
                if (FROM_FIELD.match(currentFieldName, parser.getDeprecationHandler())) {
                    ...
                    storedFieldsContext =
                        StoredFieldsContext.fromXContent(SearchSourceBuilder5.STORED_FIELDS_FIELD.getPreferredName(), parser);
    ...
    public XContentBuilder innerToXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (docValueFields != null) {
            ...
            for (FieldAndFormat docValueField : docValueFields) {
                if (Version.CURRENT.before(Version.V_6_7_1)) {
        ...
        if (trackTotalHits) {
            builder.field(TRACK_TOTAL_HITS_FIELD.getPreferredName(), true);
        }
    ...
    public boolean equals(Object obj) {
        ...
        SearchSourceBuilder5 other = (SearchSourceBuilder5) obj;
