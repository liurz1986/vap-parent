package com.vrv.vap.amonitor.es.init;
...
public final class IndexCache {
    ...
    public static void cache(ElasticSearchManager client, IndexConfig indexConfig) {
        QueryTools.QueryWrapper queryWrapper = QueryTools.build(client, indexConfig);
        try {
     ...
     * @throws IOException
     */
    private static void refreshCache(QueryTools.QueryWrapper queryWrapper) throws IOException {
        // 缓存存在的索引
     ...
     */
    private static void useOldCache(QueryTools.QueryWrapper queryWrapper) throws IOException, ClassNotFoundException {
