...
package com.vrv.vap.monitor.es.common.client;

import static org.elasticsearch.action.ValidateActions.addValidationError;

import com.vrv.vap.monitor.es.compatible.SearchSourceBuilder5;
 ...
 * <p>
 * Note, the search {@link #source(SearchSourceBuilder5)}
 ...
 * @see SearchResponse
 */
public final class SearchRequest5 extends ActionRequest implements IndicesRequest.Replaceable {
    private static final DeprecationLogger DEPRECATION_LOGGER = new DeprecationLogger(LogManager.getLogger(SearchRequest5.class));
    ...
    private SearchSourceBuilder5 source;
     ...
     */
    public SearchRequest5(SearchRequest5 searchRequest) {
     ...
     */
    public SearchRequest5(String... indices) {
        this(indices, new SearchSourceBuilder5());
    }

    /**
     * Constructs a new search request against the provided indices with the given search source.
     */
    public SearchRequest5(String[] indices, SearchSourceBuilder5 source) {
        this();
        if (source == null) {
     ...
     * milliseconds from the epoch time and whether the reduction should be final or not. Used when a {@link SearchRequest5} is created
     ...
     */
    SearchRequest5(String localClusterAlias, long absoluteStartMillis, boolean finalReduce) {
     ...
     * request. When created through {@link #SearchRequest5(String, long, boolean)}, this method returns the provided current time, otherwise
     ...
     */
    @Override
    public SearchRequest5 indices(String... indices) {
    ...
    public SearchRequest5 indicesOptions(IndicesOptions indicesOptions) {
     ...
     * all types.
     */
    public SearchRequest5 types(String... types) {
     ...
     * A comma separated list of routing values to control the shards the search will be executed on.
     */
    public SearchRequest5 routing(String routing) {
     ...
     */
    public SearchRequest5 routing(String... routings) {
     ...
     */
    public SearchRequest5 preference(String preference) {
     ...
     */
    public SearchRequest5 searchType(SearchType searchType) {
     ...
     */
    public SearchRequest5 searchType(String searchType) {
     ...
     */
    public SearchRequest5 source(SearchSourceBuilder5 sourceBuilder) {
     ...
     */
    public SearchSourceBuilder5 source() {
        return source;
    }
     ...
     * If set, will enable scrolling of the search request.
     */
    public SearchRequest5 scroll(Scroll scroll) {
        this.scroll = scroll;
        return this;
    }
     ...
     */
    public SearchRequest5 scroll(TimeValue keepAlive) {
     ...
     * If set, will enable scrolling of the search request for the specified timeout.
     */
    public SearchRequest5 scroll(String keepAlive) {
     ...
     */
    public SearchRequest5 requestCache(Boolean requestCache) {
     ...
     */
    public SearchRequest5 allowPartialSearchResults(boolean allowPartialSearchResults) {
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        source = in.readOptionalWriteable(SearchSourceBuilder5::new);
    ...
    public boolean equals(Object o) {
        ...
        SearchRequest5 that = (SearchRequest5) o;
