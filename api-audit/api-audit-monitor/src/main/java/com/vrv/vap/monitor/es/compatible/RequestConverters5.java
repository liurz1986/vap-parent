...
public final class RequestConverters5 {
     ...
     *    searches.
     */
    public static Request search(SearchRequest5 searchRequest, String searchEndpoint) throws IOException {
    ...
    private static void addSearchRequestParams(Params params, SearchRequest5 searchRequest) {
    ...
    public static class EndpointBuilder {
        ...
        public EndpointBuilder addPathPartAsIs(String ... parts) {
            for (String part : parts) {
                if (Strings.hasLength(part)) {
                    joiner.add(part);
                }
