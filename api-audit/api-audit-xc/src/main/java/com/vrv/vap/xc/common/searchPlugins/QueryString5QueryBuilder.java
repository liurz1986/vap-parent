...
// */
//
//package com.vrv.vap.xc.common.searchPlugins;
//
...
// * them using Dismax.
// */
//public class QueryString5QueryBuilder extends AbstractQueryBuilder<QueryString5QueryBuilder> {
//
...
//
//
//    public QueryString5QueryBuilder(String queryString) {
//        if (queryString == null) {
...
//     * Read from a stream.
//     */
//    public QueryString5QueryBuilder(StreamInput in) throws IOException {
//        super(in);
...
//     */
//    public QueryString5QueryBuilder defaultField(String defaultField) {
...
//     */
//    @Deprecated
//    public QueryString5QueryBuilder useAllFields(Boolean useAllFields) {
...
//     */
//    public QueryString5QueryBuilder field(String field) {
...
//     */
//    public QueryString5QueryBuilder field(String field, float boost) {
...
//     */
//    public QueryString5QueryBuilder fields(Map<String, Float> fields) {
...
//
//    /**
//     * Use {@link QueryString5QueryBuilder#tieBreaker} instead.
//     */
//    @Deprecated
//    public QueryString5QueryBuilder useDisMax(boolean useDisMax) {
//        return this;
//    }
//
//    /**
...
//     */
//    public QueryString5QueryBuilder tieBreaker(float tieBreaker) {
...
//     */
//    public QueryString5QueryBuilder defaultOperator(Operator defaultOperator) {
...
//     */
//    public QueryString5QueryBuilder analyzer(String analyzer) {
...
//     * defined for it, then it will be used automatically. Defaults to the smart search analyzer.
//     */
//    public QueryString5QueryBuilder quoteAnalyzer(String quoteAnalyzer) {
...
//     */
//    @Deprecated
//    public QueryString5QueryBuilder autoGeneratePhraseQueries(boolean autoGeneratePhraseQueries) {
//        return this;
//    }
//
//    /**
...
//     */
//    public QueryString5QueryBuilder allowLeadingWildcard(Boolean allowLeadingWildcard) {
...
//     */
//    public QueryString5QueryBuilder fuzziness(Fuzziness fuzziness) {
...
//     */
//    public QueryString5QueryBuilder fuzzyPrefixLength(int fuzzyPrefixLength) {
...
//    }
//
//    public QueryString5QueryBuilder fuzzyMaxExpansions(int fuzzyMaxExpansions) {
...
//    }
//
//    public QueryString5QueryBuilder fuzzyRewrite(String fuzzyRewrite) {
...
//     */
//    public QueryString5QueryBuilder phraseSlop(int phraseSlop) {
...
//    }
//
//    public QueryString5QueryBuilder rewrite(String rewrite) {
...
//     */
//    public QueryString5QueryBuilder analyzeWildcard(Boolean analyzeWildcard) {
...
//    }
//
//    public QueryString5QueryBuilder minimumShouldMatch(String minimumShouldMatch) {
...
//     */
//    public QueryString5QueryBuilder quoteFieldSuffix(String quoteFieldSuffix) {
...
//     */
//    public QueryString5QueryBuilder lenient(Boolean lenient) {
...
//     */
//    public QueryString5QueryBuilder timeZone(String timeZone) {
//        if (timeZone != null) {
...
//    }
//
//    public QueryString5QueryBuilder timeZone(DateTimeZone timeZone) {
...
//     */
//    public QueryString5QueryBuilder escape(boolean escape) {
//        this.escape = escape;
//        return this;
//    }
//
...
//     */
//    @Deprecated
//    public QueryString5QueryBuilder splitOnWhitespace(boolean value) {
//        return this;
//    }
//
//    /**
...
//    }
//
//    public QueryString5QueryBuilder autoGenerateSynonymsPhraseQuery(boolean value) {
//        return this;
//    }
//
//
...
//     */
//    public QueryString5QueryBuilder fuzzyTranspositions(boolean fuzzyTranspositions) {
//        return this;
//    }
//
//    @Override
...
//    }
//
//    public static QueryString5QueryBuilder fromXContent(XContentParser parser) throws IOException {
...
//        boolean escape = QueryString5QueryBuilder.DEFAULT_ESCAPE;
//        int fuzzyPrefixLength = QueryString5QueryBuilder.DEFAULT_FUZZY_PREFIX_LENGTH;
//        int fuzzyMaxExpansions = QueryString5QueryBuilder.DEFAULT_FUZZY_MAX_EXPANSIONS;
//        int phraseSlop = QueryString5QueryBuilder.DEFAULT_PHRASE_SLOP;
...
//        Operator defaultOperator = QueryString5QueryBuilder.DEFAULT_OPERATOR;
//        String timeZone = null;
//        Fuzziness fuzziness = QueryString5QueryBuilder.DEFAULT_FUZZINESS;
...
//                } else {
//                    throw new ParsingException(parser.getTokenLocation(), "[" + QueryString5QueryBuilder.NAME +
...
//        }
//        if (queryString == null) {
//            throw new ParsingException(parser.getTokenLocation(), "[" + QueryString5QueryBuilder.NAME + "] must be provided with a [query]");
//        }
//
//        QueryString5QueryBuilder queryStringQuery = new QueryString5QueryBuilder(queryString);
...
//
//    @Override
//    protected boolean doEquals(QueryString5QueryBuilder other) {
...
//                fuzziness, fuzzyPrefixLength,
//                fuzzyMaxExpansions, fuzzyRewrite, phraseSlop, tieBreaker, rewrite, minimumShouldMatch, lenient,
//                timeZone == null ? 0 : timeZone.getID(), escape);
//    }
//
//    @Override
