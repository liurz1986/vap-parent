...
public class PointConstants {
    ...
    //可接受点对点上报任务类型
    public static final String[] COMMAND_UPLOAD = {PRINT_SCREEN, VIDEO_SCREEN, PROCESS, NET_STATUS, SOFT_LIST, PKI_IN,
            PKI_OUT, POWER_ON, POWER_OFF, PRINE_RECORD, LOG_UPLOAD, ERROR_UPLOAD, SYS_INFO};
    //前端点对点可查询的指令类型
    public static final String[] COMMAND_WEB = {PRINT_SCREEN, VIDEO_SCREEN, PROCESS, NET_STATUS, SOFT_LIST};
    //点对点任务可查询的指令
    public static final String[] COMMAND_TASK = {PRINT_SCREEN, VIDEO_SCREEN, PROCESS, NET_STATUS, SOFT_LIST, PKI_IN,
            PKI_OUT, POWER_ON, POWER_OFF, PRINE_RECORD, SYS_INFO};
    //终端可查询的指令类型
    public static final String[] COMMAND_TERMINAL = {PRINT_SCREEN, VIDEO_SCREEN, PROCESS, NET_STATUS, SOFT_LIST,
            PKI_IN, PKI_OUT, POWER_ON, POWER_OFF, PRINE_RECORD, LOG_UPLOAD, ERROR_UPLOAD, SYS_INFO};
    //前端点对点可查询的任务类型
