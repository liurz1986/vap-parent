...
public class BaseLine4MysqlUtil {
    ...
    private ApiDataClient client = VapXcApplication.getApplicationContext().getBean(ApiDataClient.class);
    ...
    private static DataSource dataSource = VapXcApplication.getApplicationContext().getBean(DataSource.class);
