 ...
 * @since 2021-05-28
 */
@ApiModel(value="OltBevisitedPeopleAreaDetail对象", description="")
public class OltBevisitedPeopleAreaDetailQuery extends Query {
    ...
    public String toString() {
        return "OltBevisitedPeopleAreaDetail{" +
            "id=" + id +
            ", taskId=" + taskId +
            ", areaName=" + areaName +
            ", idCard=" + idCard +
