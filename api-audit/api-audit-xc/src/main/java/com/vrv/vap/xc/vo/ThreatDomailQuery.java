 ...
 * This class corresponds to the database table threat_domail
 *
 * @mbg.generated do_not_delete_during_merge 2018-11-20 16:17:45
 */
@ApiModel
@SuppressWarnings("unused")
public class ThreatDomailQuery extends Query {
    /**
     * 类别描述
     */
     ...
     * 数据类型包括：feed_domain
     */
    @ApiModelProperty("数据类型包括：feed_domain")
