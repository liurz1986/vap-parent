 ...
 * This class corresponds to the database table threat_email
 *
 * @mbg.generated do_not_delete_during_merge 2018-11-20 16:17:32
 */
@ApiModel
@SuppressWarnings("unused")
public class ThreatEmailQuery extends Query {
    /**
     * 类别描述
     */
     ...
     * 数据类型包括：feed_email
     */
    @ApiModelProperty("数据类型包括：feed_email")
