 ...
 * This class corresponds to the database table threat_url
 *
 * @mbg.generated do_not_delete_during_merge 2018-11-20 16:16:22
 */
@ApiModel
@SuppressWarnings("unused")
public class ThreatUrlQuery extends Query {
    /**
     * 类别描述
     */
     ...
     * 数据类型包括：feed_url
     */
    @ApiModelProperty("数据类型包括：feed_url")
