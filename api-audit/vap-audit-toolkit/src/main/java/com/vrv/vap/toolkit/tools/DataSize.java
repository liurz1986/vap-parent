...
import com.vrv.vap.toolkit.constant.DataUnit;
...
public final class DataSize implements Comparable<DataSize>, Serializable {
    ...
    /**
     * Obtain a {@link org.springframework.util.unit.DataSize} representing the specified number of bytes.
     * @param bytes the number of bytes, positive or negative
     * @return a {@link org.springframework.util.unit.DataSize}
     */
    ...
    /**
     * Obtain a {@link org.springframework.util.unit.DataSize} representing the specified number of kilobytes.
    ...
    /**
     * Obtain a {@link org.springframework.util.unit.DataSize} representing the specified number of megabytes.
    ...
    /**
     * Obtain a {@link org.springframework.util.unit.DataSize} representing the specified number of gigabytes.
    ...
    /**
     * Obtain a {@link org.springframework.util.unit.DataSize} representing the specified number of terabytes.
    ...
    /**
     * Obtain a {@link org.springframework.util.unit.DataSize} representing an amount in the specified {@link DataUnit}.
     * @param amount the amount of the size, measured in terms of the unit,
     * positive or negative
     * @return a corresponding {@link org.springframework.util.unit.DataSize}
     */
    ...
    /**
     * Obtain a {@link org.springframework.util.unit.DataSize} from a text string such as {@code 12MB} using
     ...
     * @return the parsed {@link org.springframework.util.unit.DataSize}
    ...
    public Double toMegabytes() {
        return toCorrespondingBytes(BYTES_PER_MB);
    }

    /**
     * Return the number of corresponding bytes in this instance.
     * @return the number of corresponding bytes
     */
    public Double toCorrespondingBytes(long type) {
        BigDecimal correspondingBytes = new BigDecimal(this.bytes);
        BigDecimal decimalValue = correspondingBytes.divide(new BigDecimal(type), 3, RoundingMode.HALF_UP);
    ...
    public Double toGigabytes() {
        return toCorrespondingBytes(BYTES_PER_GB);
    }
