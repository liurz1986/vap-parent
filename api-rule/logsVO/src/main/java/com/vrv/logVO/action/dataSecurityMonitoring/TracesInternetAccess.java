...
@LogDesc(value="上网痕迹",tableName="dw_device_online_detect",topicName="terminal-Intranet-internetTraceCheck-standard-v1")
@Data
public class TracesInternetAccess {
	@FieldDesc("")
    private String  id;
    @FieldDesc("设备唯一ID")
    ...
    @FieldDesc("浏览器")
    private	String 	wstr_browser;
    @FieldDesc("url")
    private	String 	wstr_url;
    @FieldDesc("访问次数")
    private	String wstr_times;
    @FieldDesc("访问时间")
    private	String 	wstr_time;
    @FieldDesc("版本")
    private	String wstr_version;
    @FieldDesc("结果")
    private	String wstr_result;
    @FieldDesc("注册人用户名")
