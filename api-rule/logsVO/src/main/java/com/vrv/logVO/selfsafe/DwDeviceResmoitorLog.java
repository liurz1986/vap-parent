...
* @version 创建时间：2019年6月25日 下午5:47:11 
* 类说明 
*/
@Data
@LogDesc(value="运行资源监控",tableName="dw_device_resmoitorlog",topicName="terminal-bigData-runResourceMonitor-standard-v1")
public class DwDeviceResmoitorLog {
    @FieldDesc("id")
	private	String	id;
	@FieldDesc("设备唯一ID")
