...
* @version 创建时间：2019年6月25日 下午5:29:34 
* 类说明 
*/
@Data
@LogDesc(value="违规服务",tableName="dw_device_servicelog",topicName="terminal-Intranet-softwareService-standard-v1")
public class DwDeviceServicelog {
