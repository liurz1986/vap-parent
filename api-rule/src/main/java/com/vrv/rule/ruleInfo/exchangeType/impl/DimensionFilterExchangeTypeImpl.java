 ...
 *
 */
public class DimensionFilterExchangeTypeImpl implements ExchangeType {

	private static Logger logger = LoggerFactory.getLogger(DimensionFilterExchangeTypeImpl.class);
	...
	public DataStreamSourceVO exchangeType(ExchangeVO exchangeVO) {
		...
		FilterDimensionTable joinDimensionTable = new FilterDimensionTable(inputFieldInfoVOs, dimensionConfig,filterCode,ruleCode);
