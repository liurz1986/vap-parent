...
public class CustomJsonRowDeserializationSchema implements DeserializationSchema<Row> {
	...
	private static Logger logger = LoggerFactory.getLogger(CustomJsonRowDeserializationSchema.class);
    ...
    public Row deserialize(byte[] message) throws IOException {
        try {
        	...
        	logger.error("Failed to deserialize JSON object.", t);
...
//        }
    ...
    public static class Builder {
        ...
        public CustomJsonRowDeserializationSchema build() {
            return new CustomJsonRowDeserializationSchema(
