...
*/
public class DataStreamSourceJdbc implements StreamTableSource<Row>,DefinedProctimeAttribute,Serializable{
	...
	public DataStreamSourceJdbc(){}
	
	
	public DataStreamSourceJdbc(String tableName){
