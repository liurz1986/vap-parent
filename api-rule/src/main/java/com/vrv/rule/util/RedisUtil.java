 ...
 *
 * @author liangguolu
 * @date 2022年06月06日 16:53
 */
public class RedisUtil {
    private static final Logger logger = LoggerFactory.getLogger(RedisUtil.class);
//    private static RedisTemplate<String,Object> redisTemplate = null;

    private volatile static RedisUtil redisUtil=null;

//    public static RedisUtil getInstance(){
//        if(redisUtil==null) {
//            logger.info("RedisUtil getInstance");
...
////            logger.info("RedisUtil initRedisTemplate is null");
////            initRedisTemplate();
////        }
//        return redisUtil;
//    }
...
//        if(redisTemplate == null){
//            logger.info("RedisUtil initRedisTemplate");
...
//            JedisConnectionFactory fac = new JedisConnectionFactory(jedisPoolConfig);
//            JedisShardInfo shardInfo = new JedisShardInfo(redisUrl, port.intValue());
//            shardInfo.setPassword(redisPwd);
//            fac.setShardInfo(shardInfo);
//            redisTemplate = new RedisTemplate<String,Object>();
////        redisTemplate.setDefaultSerializer((RedisSerializer)new StringRedisSerializer());
//            redisTemplate.setConnectionFactory((RedisConnectionFactory)fac);
//            // 设置key和value的序列化规则
