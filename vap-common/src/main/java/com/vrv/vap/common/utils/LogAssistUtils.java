...
import com.vrv.vap.common.model.FieldInfo;
...
public class LogAssistUtils {
    ...
    public static <T> List<FieldInfo> compare(T preInfo,T info){
        ...
        for (Field field : fields) {
            try {
                ...
                if(logColumn!=null && !StringUtils.isEmpty(logColumn.name())){
                ...
                if(logColumn!=null && !StringUtils.isEmpty(logColumn.mapping())){
    ...
    public static   String compareDesc(List<FieldInfo> fieldInfos,String operDesc){
        ...
        fieldInfos.stream().forEach(p->{
            stringBuffer.append(p.getDescription());
            stringBuffer.append(":");
