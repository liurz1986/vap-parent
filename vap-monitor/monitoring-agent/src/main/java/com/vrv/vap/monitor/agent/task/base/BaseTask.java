...
public abstract class BaseTask implements Job {
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        ...
        if (startTime.before(nowTime)) {
            ...
            log.info("日志信息：{}", new StringBuffer().append("before task fail force remove job:").append(jobClassName).append(" start at:").append(val)
    ...
    public abstract void run(String jobName, JobDataMap jobDataMap);

    public abstract void run(String jobName);
