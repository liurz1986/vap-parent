package com.vrv.vap.monitor.server.common.enums;
...
public enum AlarmTypeEnum {
    ...
    ALARM_WEB_ZUUL_RESULT("506","管理平台告警：网关异常尝试自动处理%s"),
