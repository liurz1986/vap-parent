...
@Configuration
@EnableSwagger2
@ConditionalOnProperty(prefix="vap.swagger", name = "enabled", havingValue = "true", matchIfMissing = true)
...
//                    .securityContexts(securityContexts());
            docket.enable(Boolean.TRUE.equals(swaggerProperties.getEnabled()) ? Boolean.TRUE : Boolean.FALSE);
...
//                .securitySchemes(securitySchemes())
//                .securityContexts(securityContexts());
        build.enable(Boolean.TRUE.equals(swaggerProperties.getEnabled()) ? Boolean.TRUE : Boolean.FALSE);
        return build;
    }
